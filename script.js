...
function checkMainHeader() {
    ...
    const mainHeaderError = document.getElementById('mainHeaderError');
    if (mainHeader.textContent.trim() === "Remove this and add your header here") {
        mainHeaderError.style.display = 'block';
        isValid = false;
    } else {
        mainHeaderError.style.display = 'none';
        isValid = true;
    }
    return isValid;
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('mainHeader').addEventListener('blur', checkMainHeader);
});